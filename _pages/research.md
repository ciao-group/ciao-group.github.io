...
<div class="rowl1">
  <img src="{{ site.url }}{{ site.baseurl }}/images/teampic/PLACEHOLDER-4.png" class="img-responsive" width="25%" style=" float: left; border-radius:7px" />
...
<div class="rowl1">
  <img src="{{ site.url }}{{ site.baseurl }}/images/teampic/PLACEHOLDER-4.png" class="img-responsive" width="25%" style=" float: right; border-radius:7px" />
